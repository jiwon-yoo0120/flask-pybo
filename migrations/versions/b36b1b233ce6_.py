...
Revision ID: b36b1b233ce6
Revises: 79f4e2664ffc
Create Date: 2022-01-26 16:52:33.310682
...
revision = 'b36b1b233ce6'
down_revision = '79f4e2664ffc'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('question_subject', sa.VARCHAR(length=200), nullable=False),
